...
namespace WebLab.Utilities
{
    public static class ControlMod
    {
        ...
        public static int AsInt<T>(this T value) where T : struct, IConvertible
        {
            if (typeof(T).IsEnum)
            {
        ...
        public const string constAppMainKey = "Software\\StudentSectionUpdater";
        ...
        public static string SplitterByUnderscore(string strToSplit)
        {
            string res = "";
            try
            {
